# Perfect Sessions Demo, MongoDB Driver
...
This demo shows usage of Perfect Sessions with the MongoDB Driver.
...
In Perfect Assistant, click "Create New Project", and select "Custom repository URL". Choose a location for the project, and enter this URL for "Repository URL": `https://github.com/PerfectExamples/Perfect-Session-MongoDB-Demo.git`
...
```
git clone https://github.com/PerfectExamples/Perfect-Session-MongoDB-Demo.git
cd Perfect-Session-MongoDB-Demo
swift build
.build/debug/Perfect-Session-MongoDB-Demo
```
